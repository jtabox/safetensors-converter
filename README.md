...
_(yes, the 10000th one on github but whatever)_
...
pip install 'torch' # Any variant will work (CPU/GPU)
...
Make sure you **test the produced .safetensors** files _before deleting your original files_!
...
- It will automatically write a JSON file with more details about each file's conversion results at the end of the process (_I'll admit I can't really see the point or value of this, I just felt it'd be a nice touch for some reason to have a JSON somewhere_)
